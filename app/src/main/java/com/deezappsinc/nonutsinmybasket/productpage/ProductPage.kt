package com.deezappsinc.nonutsinmybasket.productpage
...
import com.deezappsinc.nonutsinmybasket.productpage.api.MainViewModel
import com.deezappsinc.nonutsinmybasket.productpage.api.MainViewModelFactory
import com.deezappsinc.nonutsinmybasket.productpage.api.Repository
    ...
    private fun getProductData(barcodeData: String, ingredientsText: ArrayList<String>) {
        ...
        viewModel.myResponseDynamic.observe(this, Observer { response ->
            if (response.isSuccessful) {
                ...
                if(imageURL==null)
                    Glide.with(this).load(R.drawable.logo_blue_seperate).into(imageView)
                else {
